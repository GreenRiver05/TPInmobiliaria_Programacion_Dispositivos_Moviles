...
//Esta clase sirve para conectarse a la API
public class ApiClient {
    ...
    //Aca se definen los metodos para conectarse a la API
    ...
    //Guardo el token en SharedPreferences para poder usarlo en las siguientes peticiones
